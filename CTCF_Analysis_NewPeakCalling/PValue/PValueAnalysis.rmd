...
file_list_CTCF <- list(
    ...
    CHIP42 = "/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/CHIP.v.CNR_Git1/UnifiedPeakCalling/CHIP_CTCF_PeakCalling/CHIP_CTCF_42_PeakCalls_peaks.broadPeak",
...
pValue_Plot_sampleXsample_CTCF <-ggplot(df_CTCF, aes(x = value, colour = sample))+
    ...
    labs(title = "Variance between Samples in CTCF", x = "-log10(pvalue)")
ggsave("/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/CHIP.v.CNR_Git/CTCF_Analysis_NewPeakCalling/PValue/Plots/PValuePlot_CTCF.png", pValue_Plot_sampleXsample_CTCF, height = 7, width = 7, dpi = 300)
