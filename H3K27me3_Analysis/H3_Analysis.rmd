...
adj <- filter_by_pvalue(data, pvalue = 0.001)
...
write_bed(uniqueCHIP, "/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/ChIP.v.CnR/GeneralR_script_CHIP_CUT/BEDFiles/H3K27_BED/uniqueCHIP.bed")
write_bed(uniqueCNR, "/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/ChIP.v.CnR/GeneralR_script_CHIP_CUT/BEDFiles/H3K27_BED/uniqueCNR.bed")

#Overlapped Peaks: 
write_bed(overlapCHIP, "/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/ChIP.v.CnR/GeneralR_script_CHIP_CUT/BEDFiles/H3K27_BED/overlap_CHIP.bed")
write_bed(overlapCNR, "/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/ChIP.v.CnR/GeneralR_script_CHIP_CUT/BEDFiles/H3K27_BED/overlap_CNR.bed")

#Filtered and Merged BEDs: 
write_bed(CHIP, "/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/ChIP.v.CnR/GeneralR_script_CHIP_CUT/BEDFiles/H3K27_BED/filtered_CHIP.bed")
write_bed(CNR, "/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/ChIP.v.CnR/GeneralR_script_CHIP_CUT/BEDFiles/H3K27_BED/filtered_CNR.bed")
```
...
write.csv(propOverlabTibble, "/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/ChIP.v.CnR/GeneralR_script_CHIP_CUT/H3K27me3_Analysis/Proportion_Overlap_Tables/H3K27.csv")
write_xlsx(propOverlabTibble, "/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/ChIP.v.CnR/GeneralR_script_CHIP_CUT/H3K27me3_Analysis/Proportion_Overlap_Tables/H3K27.xlsx" )
```
...
ggsave("/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/ChIP.v.CnR/GeneralR_script_CHIP_CUT/H3K27me3_Analysis/WidthAnalysisPlots/H3K27.png", widthGGplot, height = 7, width = 7, dpi = 300)
...
Peak Analysis: 
```{R}
pdf("/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/ChIP.v.CnR/GeneralR_script_CHIP_CUT/H3K27me3_Analysis/PeakAnnotations/H3K27_PeakAnnoation_Bar.pdf", heigh = 3, width = 10)
par(mfrow = c(1, 2))
...
pdf("/Volumes/groups/bakergrp/projects/baker_data/bakergrp/analyses/JM/ChIP.v.CnR/GeneralR_script_CHIP_CUT/H3K27me3_Analysis/PeakAnnotations/H3K27_PeakAnnoation_Pie.pdf", heigh = 7, width = 7)
par(mfrow = c(1, 2))
